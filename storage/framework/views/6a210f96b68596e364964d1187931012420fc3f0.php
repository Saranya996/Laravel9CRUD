                ...
                <form method="post" action="<?php echo e(route('tasks.store')); ?>">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="name" id="image" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Assignment\backend\resources\views/tasks/create.blade.php ENDPATH**/ ?>